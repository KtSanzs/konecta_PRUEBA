          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-sm-7">
                  <input type="text" class="form-control" name="rol" placeholder="Ingrese rol" value="{{ old('rol') }}">
                  @if ($errors->has('rol'))
                    <span class="error text-danger" for="input-username">{{ $errors->first('rol') }}</span>
                  @endif
                </div>
              </div>
              <div class="row">
