@extends('layouts.main', ['activePage' => 'customers', 'titlePage' => 'Detalles del Cliente'])
@section('content')
<div class="content">
      ...
      <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-header card-header-primary">
            ...
            <p class="card-category">Vista detallada de {{ $customer->name }}</p>
          </div>
          <!--End header-->
          <!--Body-->
          <div class="card-body">
                    ...
                    <p class="card-text">
                      <div class="author">
                        ...
                        <a href="#">
                          ...
                          <h5 class="title mt-3">{{ $customer->name }}</h5>
                        </a>
                        <p class="name">
                          {{ _('Admin/Vendedor') }} <br>
                          {{ $customer->name }} <br>
                          {{ $customer->document_id }} <br>
                          {{ $customer->email }} <br>
                          {{ $customer->address }} <br>
                          {{ $customer->created_at }}
                        </p>
